document.addEventListener("DOMContentLoaded", function () {
  ...
  //adiciona um botao que volta ao menu inicial
  ...
  if (e.key === "e" || e.key === "E") {
    if (currentMap === "casa" && nearLemonade) {
      ...
      if (dialogManager.active && dialogManager.type === "lemonade") {
        ...
        //tentar interação com a barraca de limonada adicionando "sim" e "não"
        dialogManager.show(
          "lemonade",
          ...
          [
            {
              text: "Sim",
              action: () => {
                perderMoedas(25); // função para descontar 25 moedas do usuário
                dialogManager.hide();
              },
            },
            {
